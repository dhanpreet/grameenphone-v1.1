...
<body>
	...
	<div class="col-xs-12 padd">  
        <div class="touraments-profile "> 
          ...
          <span class="pull-left"><a href="javascript:history.go(-1)"><img src="<?php echo base_url() ?>assets/frontend/img/icons/back.png" height="14"></a></span>
        ...
        <div class="main-container">
            <div class="col-xs-12 align-middle padd first-rank">
                ...
                <div class="col-xs-8 text-center"><span class="text-white">Your best score is</span><span class="text-dark theme-color"><?php $myScore = $playersInfo[0]['player_score']; echo @$myScore; ?></span></div>
            </div>
            <!-- Table -->
