        ...
        <div class="row">   <br><br><br><br>		</div>
				...
				<br><br><br>
						...
						<div class="input-group">
							...
							<input  type="email" name="user_email" class="form-control text-field" value="<?php echo $userInfo['user_email_2']; ?>" placeholder="Email Address"  autocomplete="none"  /><br>
						...
						<?php if(@$userInfo['user_type'] == 1 || @$userInfo['user_type'] == 2 ){ ?>
						<div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 m-t-15 padd">
						<br>
						<div class="input-group">
