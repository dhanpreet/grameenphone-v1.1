...
<?php
		...
		$apiURL = "https://multiplayergameserver.com/xmlapi7/xmlapi.php?site_id=834&password=GiK2Xz9Ty&nocompress=true&action=get_games&game_id=".$game_id."&show_description=true&show_help=true&show_tip=true&exclude_category_id=0";
			...
			$description = @$responseArray['games']['game_0']['description'];  // Type is string
			$requirements = @$responseArray['games']['game_0']['requirements']; // Type is array
			$gamehelp = @$responseArray['games']['game_0']['gamehelp'];   // Type is string
			$gametip = @$responseArray['games']['game_0']['gametip'];  // Type is array
