...
<section class="footer-wrapper" align="center">
	...
	<div class="container">
			...
			<?php if($userInfo['user_type']=='2'){ ?>
			<div class="col-3 col-xs-3 col-sm-3 col-md-3 col-lg-3 text-center">
				<a  href="#" class="buy-bundle <?php if($this->uri->segment(1)=='UserSubscription'){ echo "theme-color"; }else{ echo "text-white"; } ?>">
					<i class="f1h2vptk fa fa-cart-arrow-down <?php if($this->uri->segment(1)=='UserSubscription'){ echo "theme-color"; }else{ echo "text-white"; } ?>"></i><span>
					<br>Buy Bundle 
