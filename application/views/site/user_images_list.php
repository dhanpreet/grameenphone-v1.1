...
<div id="load"></div>
	<section>
		<div class="f1lhk7ql">
		<a onclick="window.history.back();"><img class="f1iowekn" src="<?php echo base_url() ?>assets/frontend/img/icons/back.png"></a>
		<div class="f1py95a7" style="text-transform: capitalize; color: rgb(255, 255, 255);"><?php echo @$genreName ?> Select profile Image</div>
		</div>
