...
<head>
   ...
   <!-- Meta Tags for SEO Ends -->
	...
	<style>
		...
		.iframeWrapper {position: absolute; width: 100vw !important; height: 90vh !important; top: 40px; left: 0; right: 0; bottom: 0;  }
		.iframeWrapper iframe {display: block; width: 100vw !important; height: 90vh !important; border: none;}
...
<!-- File  to handle the user time for the page or session -->	
