...
<div class="row text-center masonry js-masonry js-images-loaded"> 
	<div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat1 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/1.jpg'); ?>" /></div>
	<div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat2 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/2.jpg'); ?>" /></div>
    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat3 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/3.jpg'); ?>" /></div>
    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat4 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/4.jpg'); ?>" /></div>
    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat5 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/5.jpg'); ?>" /></div>
	<div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat6 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/6.jpg'); ?>" /></div>
	<div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat7 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/7.jpg'); ?>" /></div>

    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat8 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/8.jpg'); ?>" /></div>
    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat9 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/9.jpg'); ?>" /></div>
    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat10 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/10.jpg'); ?>" /></div>
    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat11 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/11.jpg'); ?>" /></div>
    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat12 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/12.jpg'); ?>" /></div>
	<div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat13 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/13.jpg'); ?>" /></div>
	<div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat14 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/14.jpg'); ?>" /></div>
    
	<div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat15 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/15.jpg'); ?>" /></div>
    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat16 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/16.jpg'); ?>" /></div>
    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat17 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/17.jpg'); ?>" /></div>
	<div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat18 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/18.jpg'); ?>" /></div>
	<div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat19 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/19.jpg'); ?>" /></div>
	<div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat20 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/20.jpg'); ?>" /></div>
    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat21 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/21.jpg'); ?>" /></div>
  
    
	<div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat22 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/22.jpg'); ?>" /></div>
    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat23 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/23.jpg'); ?>" /></div>
    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat24 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/24.jpg'); ?>" /></div>
	<div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat25 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/25.jpg'); ?>" /></div>
	<div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat26 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/26.jpg'); ?>" /></div>
    <div class="col-xs-6 col-sm-6 col-md-2 col-lg-2 col-xl-2 masonry__item js-masonry-item"><img class="float-img repeat27 animated fadeInUp" src="<?php echo base_url('uploads/suggested-games/27.jpg'); ?>" /></div>
				...
				<div class="row text-box-position2 white-bg ">
					...
					<form action="<?php echo site_url('site/verifyUserLogin') ?>" method="post" autocomplete="none">
						<div id="login_with_phone">
						    ...
						    <div class="col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12 m-t-15 padd">
								 <br><br>
								<b>New User? <a href="<?php echo site_url('SignUp') ?>">Sign up</a></b>
							 </div>
