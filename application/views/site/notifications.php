						...
						<div class="row bg-row module" style="padding-top:10px !important;">
							...
							<div class="col-2 col-xs-2 col-sm-2 col-md-2 col-lg-2">
								<?php  if($tRow['notify_type'] == '1'){  ?>
									<img src="<?php echo base_url('assets/frontend/img/notify-icons/tournament-joined.png') ?>"  style="width:150%;"/>
								<?php } else  if($tRow['notify_type'] == '2'){  ?>
									<img src="<?php echo base_url('assets/frontend/img/notify-icons/spin-win.png') ?>"  style="width:150%;"/>
								<?php } else  if($tRow['notify_type'] == '3'){  ?>
									<img src="<?php echo base_url('assets/frontend/img/notify-redeem.png') ?>"  style="width:150%;"/>
								<?php } else  if($tRow['notify_type'] == '4'){  ?>
									<img src="<?php echo base_url('assets/frontend/img/notify-tournament-reward.png') ?>"  style="width:150%;"/>
								<?php } else  if($tRow['notify_type'] == '5'){  ?>
									<img src="<?php echo base_url('assets/frontend/img/notify-icons/edit-profile.png') ?>"  style="width:150%;"/>
								<?php } else  if($tRow['notify_type'] == '6'){  ?>
									<img src="<?php echo base_url('assets/frontend/img/notify-icons/subscription-coins.png') ?>"  style="width:150%;"/>
								<?php } else  if($tRow['notify_type'] == '7'){  ?>
									<img src="<?php echo base_url('assets/frontend/img/notify-icons/tournament-reward.png') ?>"  style="width:150%;"/>
								<?php } else  if($tRow['notify_type'] == '8'){  ?>
									<img src="<?php echo base_url('assets/frontend/img/notify-icons/reward-claimed.png') ?>"  style="width:150%;"/>
								<?php } else  if($tRow['notify_type'] == '9'){  ?>
									<img src="<?php echo base_url('assets/frontend/img/notify-icons/reward-expired.png') ?>"  style="width:150%;"/>
								<?php  }  ?>
							</div>
