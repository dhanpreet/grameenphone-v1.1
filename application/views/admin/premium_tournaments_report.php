...
<head>
	<meta charset="utf-8" />
	<title>GSL | Premium Report</title>
                                ...
                                <div class="card">
                                    <div class="card-body">
									  ...
									  <div class="row">
											...
											<form id="searchForm" action="<?php echo site_url('Admin/PremiumTournamentsFilter'); ?>" method="post"> 
												<div class="form-group row" style=" text-align:right; ">
													...
													<div class="col-md-8" style="padding: 0 !important;"> 
														<select class="form-control" name="search" id="search">
															<option value='all' <?php if(@$filter == '') { echo "selected"; } ?>>Choose Filter</option>
                                        ...
                                        <table id="myDataTable" class="table ">
											...
											<?php foreach($list as $row){  ?>
												<tr>
													...
													<td width="10%" class="text-center">
														<a href="<?php echo site_url('Admin/PremiumTournaments/Leaderboard/'.base64_encode($row['tournament_id'])); ?>" data-toggle="tooltip" data-title="Leaderboard"><i data-feather="file-text" width="24" height="24"></i></a>
														&nbsp;&nbsp;
														<a href="<?php echo site_url('Admin/PremiumTournaments/PlayStats/'.base64_encode($row['tournament_id'])); ?>" data-toggle="tooltip" data-title="Play-Stats"><i data-feather="trending-up" width="24" height="24"></i></a>
	...
	<div class="modal fade" id="customDates" tabindex="-1" aria-labelledby="customDatesLabel" aria-hidden="true">
	  <div class="modal-dialog">
		<div class="modal-content">
		  ...
		  <form action="<?php echo site_url('Admin/PremiumTouramentsDateFilters'); ?>" method="post"> 
