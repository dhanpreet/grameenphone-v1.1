...
<head>
											...
											<?php foreach($list as $row){  ?>
                                                <tr>
                                                   ...
                                                   <td class="text-center">
														...
														<a href="javascript: void(0);" data-toggle="modal" data-target="#info_<?php echo $row['gid']; ?>"><i data-feather="info" width="24" height="24"></i></a>
													</td>
    ...
    <?php if(is_array($list) && count($list)>0){ $i=1;  ?>
	<?php foreach($list as $rows){  ?>
		<div id="info_<?php echo $rows['gid']; ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					<div class="modal-header">
						<h5 class="modal-title" id="myModalLabel"> Game Information</h5>
						<button type="button" class="close" data-dismiss="modal" aria-label="Close">
							<span aria-hidden="true">&times;</span>
						</button>
					</div>
					...
					<?php
					//$game_gb_id = $rows['id'];
					//$gameDetails = $this->db->query("SELECT * FROM tbl_games_desc WHERE id = '$game_gb_id' ")->row();
					...
					<div class="modal-body">
						...
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Screen</label>
							<div class="col-md-8">
								<b><?php echo stripslashes(urldecode($rows['screen'])); ?></b>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<b><?php echo stripslashes(urldecode($rows['description'])); ?></b>
							</div>
						</div>
						...
						<div class="form-group row">
							...
							<div class="col-md-8">
								<b><?php echo stripslashes(urldecode($rows['requirements'])); ?></b>
							</div>
						</div>
						
						<br>
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Help</label>
							<div class="col-md-8">
								<b><?php echo stripslashes(urldecode($rows['gamehelp'])); ?></b>
							</div>
						</div>
						
						<br>
						<div class="form-group row">
							<label class="col-md-4 col-form-label">Tip</label>
							<div class="col-md-8">
								<b><?php echo stripslashes(urldecode($rows['gametip'])); ?></b>
							</div>
						</div>
