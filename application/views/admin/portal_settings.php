                            ...
                            <div class="col-lg-12">
                                <div class="card">
                                    ...
                                    <div class="card-body">
										...
										<div class="form-group row">
											<label class="col-md-6 col-form-label"><h5 class="section-heading"> Live Tournaments - Small Tournaments </h5></label>
											<div class="col-md-6 text-center"><br>
												<div class="custom-control custom-switch ">
													<input type="checkbox" class="custom-control-input active_banner" id="small_tournaments" name="small_tournaments" <?php if( search_exif($list, 'small_tournaments') ){ echo "checked"; } ?>>
													<label class="custom-control-label" for="small_tournaments">&nbsp; </label>
												</div>
											</div>
										</div>
