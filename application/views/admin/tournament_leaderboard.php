                                        ...
                                        <table id="myDataTable" class="table ">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th width="10%" class="text-center">Reward Voucher</th>
											...
											<?php foreach($list as $row){  ?>
                                                <tr>
                                                    ...
                                                    <td width="10%"><?php echo $row['user_phone']; ?></td>
													...
													<td width="10%" class="text-center">
													<?php 
													//if($tournamentInfo['player_reward_prize'] < $today){ 
