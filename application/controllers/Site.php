...
class Site extends CI_Controller {
	...
	public function createGameboostId_old($userId, $gameboostEmail=''){
		if(!empty($userId)){
	...
	public function createGameboostIdTest(){
		$userId = '57665';
		if(!empty($userId)){
	...
	public function useraccess(){
		...
		if(empty($token)){
			...
			// Get unseen tournaments results
			$prizeUnseen	= $this->SITEDBAPI->getUserUnseenResults($uid);
			$this->unseenTournamentsResults = $prizeUnseen;
