...
$route['Admin/Vouchers'] = 'admin/getVouchersList';
$route['Admin/VoucherType'] = 'admin/getVoucherTypes';
$route['Admin/AssignmentOver'] = 'admin/getAssignmentOverVoucher';

// $route['Admin/Tournaments/Leaderboard/(:any)'] = 'admin/getTournamentLeaderboard/$1';
// $route['Admin/Tournaments/PlayStats/(:any)']    =   'admin/getTournamentPlayStats/$1';
// $route['Admin/TouramentsDateFilters'] = 'admin/getTouramentsDateFilters';

$route['Admin/TournamentsReport'] = 'admin/getTournament';
$route['Admin/TournamentsFilter'] = 'admin/getTournamentsFilter';
$route['Admin/Tournaments/Leaderboard/(:any)'] = 'admin/getTournamentLeaderboard/$1';
$route['Admin/Tournaments/PlayStats/(:any)'] = 'admin/getTournamentPlayStats/$1';
$route['Admin/TouramentsDateFilters']   =   'admin/getTouramentsDateFilters';


$route['Admin/PremiumTournamentsReport'] = 'admin/getPremiumTournament';
$route['Admin/PremiumTournamentsFilter'] = 'admin/getPremiumTournamentsFilter';
$route['Admin/PremiumTouramentsDateFilters']   =   'admin/getPremiumTouramentsDateFilters';
$route['Admin/PremiumTournaments/Leaderboard/(:any)'] = 'admin/getPremiumTournamentLeaderboard/$1';
$route['Admin/PremiumTournaments/PlayStats/(:any)'] = 'admin/getPremiumTournamentPlayStats/$1';
$route['Admin/FreeGamesStats'] = 'admin/getFreeGamesStats';
...
$route['Games'] = 'site/getallGenreGames';
$route['Games/(:any)'] = 'site/getGenreGames/$1';
$route['site/User/(:any)/(:any)'] = 'site/index/$1';
...
$route['leaderboard'] = 'site/leaderboard';
$route['logout'] = 'site/logout1';
$route['SignUp'] = 'site/userSignup';
$route['SignUpverify'] = 'site/userSignupverified';
$route['site/User/(:any)'] = 'site/index/$1';


$route['getToken'] = 'Gp/getToken';
$route['UserLogin'] = 'Gp/updateUserLogin';
$route['bundlePurchaseCallback'] = 'Gp/updateSubscriptionCallback';
$route['cancelBundleCallback'] = 'Gp/cancelSubscriptionCallback';

$route['UserAccess/(:any)/(:any)'] = 'site/useraccess/$1/$2';
$route['UserAccess'] = 'site/useraccess';
$route['UserAccessPortal'] = 'site/showPortal';
$route['Welcome/(:any)'] = 'site/PremiumUser/?token=$1';

$route['home/(:any)'] = 'site/index/$1';
$route['home/(:any)/(:any)'] = 'site/index/$1/$2';
$route['LoginError'] = 'site/JwtError';

$route['RedeemModalData'] = 'site/RedeemModalData';
$route['RedeemVoucher/(:any)/(:any)'] = 'site/RedeemVoucher/$1/$2';
$route['Admin/UserRegistered'] = 'admin/getUserRegistered';
$route['Admin/FilterUserRegistered'] = 'admin/getFilteredUserRegistered';
$route['Admin/DateFilterUserRegistered'] = 'admin/getDateFilterUserRegistered';
$route['Admin/ExportUserRegistered/(:any)'] = 'admin/getExportUserRegistered/$1';
$route['Admin/UserPlayStats/(:any)'] = 'admin/getUserPlayStats/$1';
$route['Admin/ExportRangeUserRegistered/(:any)/(:any)'] = 'admin/getExportRangeUserRegistered/$1/$2';
/*
| -------------------------------------------------------------------------
