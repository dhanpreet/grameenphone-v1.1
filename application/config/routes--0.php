...
$route['Admin/GameReport'] = 'admin/getInstantGameReport';
$route['Admin/TournamentsReport'] = 'admin/tournamentReports';
$route['Admin/TournamentsFilter'] = 'admin/getTouramentsFilter';
